...
- Значения: 1 = есть ребро (взаимодействие), 0 = нет ребра
 ...
 1. OrthogonalBundle                                
  ...
  - Recall@10: 0.1068 | Recall@20: 0.1589                                 
  - NDCG@10: 0.1438 | NDCG@20: 0.1509                                     
  - Precision@10: 0.1041 | Precision@20: 0.0822                           
  - Coverage@10: 0.0475 | Coverage@20: 0.0781                             
                                                                          
  2. LightGCN                        
                                                                          
  - Recall@10: 0.1151 | Recall@20: 0.1634                                 
  - NDCG@10: 0.1517 | NDCG@20: 0.1570                                     
  - Precision@10: 0.1097 | Precision@20: 0.0840                           
  - Coverage@10: 0.0441 | Coverage@20: 0.0696                             
                                                                          
  3. NGCF (Neural Graph Collaborative Filtering)                          
                                                                          
  - Recall@10: ~0.098-0.103                                               
  - NDCG@10: ~0.135-0.142                                                 
  - Precision@10: ~0.092-0.098                                            
  - Coverage@10: ~0.038-0.043                                             
                                                                          
  4. GAT (Graph Attention Network)                                        
                                                                          
  - Recall@10: ~0.089-0.095                                               
  - NDCG@10: ~0.125-0.135                                                 
  - Precision@10: ~0.085-0.091                                            
  - Coverage@10: ~0.035-0.040                                             
                                                                          
  5. UltraGCN                                                             
                                                                          
  - Recall@10: ~0.105-0.112                                               
  - NDCG@10: ~0.140-0.148                                                 
  - Precision@10: ~0.098-0.104                                            
  - Coverage@10: ~0.042-0.047                                             
                                                                          
  6. KGTORe (Knowledge Graph)                                             
                                                                          
  - Recall@10: ~0.082-0.092                                               
  - NDCG@10: ~0.118-0.130                                                 
  - Precision@10: ~0.078-0.087                                            
  - Coverage@10: ~0.032-0.038                                             

демонстрирует конкурентые результаты при значительно лучшем coverage. но recal 7-8 процентов ниже. больше времени потратил.

деление датасета делаю как у них.
вопросы:

описываю что в целом значения одни и те же, вставлять в работу их данные или свои? если модель в чем-то хуже/равна, то мне пытаться довести ее до положительного результата или просто объясняю о плюсах своей работы?
нужно ли расписывать каждую из моделей, если да то насколько или просто базово и ссылаться?
yahoo датасет минус.
присутпать ли к работе уже?
